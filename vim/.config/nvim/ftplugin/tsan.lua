...
vim.keymap.set('n', ']s', goto_next_stack, { buffer = true })
vim.keymap.set('n', '[s', goto_previous_stack, { buffer = true })
vim.keymap.set('n', ']w', goto_next_tsan_warning, { buffer = true })
vim.keymap.set('n', '[w', goto_previous_tsan_warning, { buffer = true })
